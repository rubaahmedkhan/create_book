// @ts-check
// Module 4: Vision-Language-Action Configuration

/** @type {import('@docusaurus/types').Config} */
const config = {
  title: 'Module 4: Vision-Language-Action',
  tagline: 'Multimodal Integration & Capstone',
  favicon: 'img/favicon.ico',

  url: 'https://rubaahmedkhan.github.io',
  baseUrl: '/create_book/module4/',
  ...
  themeConfig:
    ...
    ({
      ...
      footer: {
        style: 'dark',
        copyright: `Module 4: Vision-Language-Action | Licensed under CC BY 4.0`,
      },
      prism: {
